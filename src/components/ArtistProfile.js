  ...
  componentDidMount() {
    for (let i = 0; i < artists.length; i++) {
      if (this.props.params.username === artists[i].id) {
        ...
        SC.oEmbed(this.state.embed, {
          element: document.getElementById('sc-embed'),
        });
      }
    }
  }
      ...
      <div className='main-container'>
        ...
        <div className='container'>
          ...
          <div
            ...
            className='artist-profile-header col-lg-12 col-md-12 img-responsive'
            role='presentation'
          >
          ...
          <div className='col-md-9'>
            ...
            <div className='embed-responsive embed-responsive-16by9'>
              <iframe
                ...
                src={this.state.artists.youtube}
              ></iframe>
            </div>
          </div>
